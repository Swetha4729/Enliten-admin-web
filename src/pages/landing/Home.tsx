...
const Home = () => {
  ...
  const products = [
    ...
    {
      title: 'Quiz Modes',
      description: 'Choose from 8 different quiz modes to suit your learning style.',
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12 md:mb-20">
              ...
              <p className="text-base md:text-lg text-white/60 leading-relaxed max-w-3xl mx-auto">
                Designed for aspiring professionals - quiz systems, mock tests, and performance insights that power your certification journey.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
              ...
              <div className="h-64 md:h-80 lg:h-[500px] relative rounded-2xl overflow-hidden professional-card order-first lg:order-last">
                ...
                <div className="absolute inset-0 bg-[url('/icon1.jpeg')] bg-cover bg-center opacity-70" />
                <div className="absolute bottom-0 left-0 right-0 p-4 md:p-8 bg-gradient-to-t from-slate-900 via-slate-900/80 to-transparent">
                  <h3 className="text-xl md:text-2xl lg:text-xl font-extrabold mb-2 md:mb-4 gradient-text">
                    Forge your expertise
                  </h3>
                  <p className="text-white/60 text-sm md:text-base lg:text-s leading-relaxed">
                    More than questions — it’s a journey to cybersecurity mastery.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 md:py-24 lg:py-32 relative overflow-hidden bg-gradient-to-b from-slate-950 to-slate-900">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-semibold tracking-tight gradient-text">
                Ready to Level Up Your Cyber Journey?
              </h2>
              <p className="text-lg md:text-xl lg:text-2xl text-white/70 leading-relaxed">
                Join the community of future-ready professionals. Explore our powerful prep tools or connect with us to accelerate your certification success.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button onClick={() => window.open('https://play.google.com/store/apps/details?id=com.cyber.cruciora', '_blank')} className="professional-button text-base md:text-lg py-4 px-8 md:py-6 md:px-10 w-full sm:w-auto">
                  Try Cyber Cruciora for free
                </Button>
